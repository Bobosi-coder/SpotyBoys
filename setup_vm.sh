...
export MLFLOW_TRACKING_URI="http://129.114.27.10:8000/"
# 持久化到 ~/.bashrc，SSH 重连后自动生效（覆盖旧值）
sed -i '/MLFLOW_TRACKING_URI/d' "${HOME}/.bashrc"
echo 'export MLFLOW_TRACKING_URI=http://129.114.27.10:8000/' >> "${HOME}/.bashrc"
